...
**Last Updated:** `2026-08-18 14:12:55 UTC`  
...
| **Bhubaneswar** | India | Malaria/Dengue | 28.01°C | 88.9% | `0.86` |
| **Panama City** | Panama | Dengue | 27.17°C | 87.48% | `0.86` |
| **Kolkata** | India | Dengue/Malaria | 28.36°C | 87.48% | `0.85` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 25.83°C | 87.76% | `0.85` |
| **Lucknow** | India | Dengue/JE | 28.84°C | 86.29% | `0.85` |
| **Manila** | Philippines | Dengue | 27.02°C | 85.62% | `0.84` |
| **New Delhi** | India | Dengue/Chikungunya | 28.8°C | 85.24% | `0.84` |
| **Dhaka** | Bangladesh | Dengue | 28.51°C | 84.95% | `0.84` |
...
| **Abidjan** | Cote d'Ivoire | Malaria | 25.12°C | 83.67% | `0.82` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.38°C | 80.1% | `0.81` |
| **Bangkok** | Thailand | Dengue | 28.22°C | 80.29% | `0.81` |
| **Jaipur** | India | Dengue/Malaria | 28.04°C | 79.95% | `0.81` |
| **Pune** | India | Dengue/Zika | 24.2°C | 84.33% | `0.81` |
| **Accra** | Ghana | Malaria | 25.59°C | 80.33% | `0.80` |
| **San Juan** | Puerto Rico | Dengue | 28.4°C | 77.62% | `0.79` |
...
| **Miami** | United States | Low Baseline | 29.01°C | 77.48% | `0.78` |
| **Singapore** | Singapore | Dengue | 28.25°C | 75.67% | `0.77` |
| **Hyderabad** | India | Dengue/Malaria | 26.26°C | 74.0% | `0.75` |
| **Dar es Salaam** | Tanzania | Malaria | 24.79°C | 75.52% | `0.75` |
| **Havana** | Cuba | Dengue | 28.79°C | 73.67% | `0.74` |
| **Bengaluru** | India | Dengue | 23.47°C | 77.57% | `0.72` |
| **Tegucigalpa** | Honduras | Dengue | 23.45°C | 77.14% | `0.71` |
| **Guayaquil** | Ecuador | Dengue | 27.57°C | 68.95% | `0.70` |
| **Jakarta** | Indonesia | Dengue | 28.74°C | 68.19% | `0.68` |
| **Chennai** | India | Dengue/Chikungunya | 30.1°C | 70.57% | `0.67` |
| **Rio de Janeiro** | Brazil | Dengue | 22.61°C | 77.14% | `0.67` |
