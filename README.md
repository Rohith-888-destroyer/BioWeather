...
**Last Updated:** `2026-09-22 19:36:14 UTC`  
...
| **Panama City** | Panama | Dengue | 26.99°C | 88.24% | `0.86` |
| **Bhubaneswar** | India | Malaria/Dengue | 27.68°C | 87.29% | `0.86` |
| **Bangkok** | Thailand | Dengue | 27.16°C | 85.9% | `0.85` |
| **Manila** | Philippines | Dengue | 27.1°C | 85.67% | `0.85` |
| **Lagos** | Nigeria | Malaria | 26.2°C | 86.29% | `0.84` |
| **Kolkata** | India | Dengue/Malaria | 28.27°C | 84.57% | `0.84` |
| **Santo Domingo** | Dominican Republic | Dengue | 26.96°C | 84.14% | `0.84` |
| **Colombo** | Sri Lanka | Dengue | 27.1°C | 83.62% | `0.84` |
| **Veracruz** | Mexico | Dengue | 27.39°C | 82.57% | `0.83` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 27.05°C | 82.33% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.4°C | 84.33% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.44°C | 81.76% | `0.82` |
| **Miami** | United States | Low Baseline | 27.15°C | 81.14% | `0.82` |
| **Cartagena** | Colombia | Dengue | 28.72°C | 81.48% | `0.81` |
| **Accra** | Ghana | Malaria | 26.14°C | 81.05% | `0.81` |
| **Havana** | Cuba | Dengue | 27.41°C | 80.19% | `0.81` |
| **San Juan** | Puerto Rico | Dengue | 28.2°C | 79.81% | `0.81` |
| **Dhaka** | Bangladesh | Dengue | 29.25°C | 79.29% | `0.79` |
| **Guayaquil** | Ecuador | Dengue | 27.31°C | 77.14% | `0.79` |
| **Pune** | India | Dengue/Zika | 24.88°C | 78.67% | `0.78` |
| **Dar es Salaam** | Tanzania | Malaria | 25.42°C | 75.86% | `0.76` |
| **Tegucigalpa** | Honduras | Dengue | 23.16°C | 81.71% | `0.75` |
| **Ahmedabad** | India | Dengue/Malaria | 28.95°C | 72.52% | `0.72` |
| **Chennai** | India | Dengue/Chikungunya | 29.82°C | 73.14% | `0.71` |
| **Hyderabad** | India | Dengue/Malaria | 27.11°C | 69.43% | `0.70` |
| **New Delhi** | India | Dengue/Chikungunya | 28.91°C | 70.76% | `0.70` |
| **Kampala** | Uganda | Malaria | 22.3°C | 81.48% | `0.69` |
| **Rio de Janeiro** | Brazil | Dengue | 21.55°C | 86.86% | `0.69` |
| **Bengaluru** | India | Dengue | 24.64°C | 69.71% | `0.67` |
| **Kinshasa** | DR Congo | Malaria | 26.46°C | 66.05% | `0.66` |
