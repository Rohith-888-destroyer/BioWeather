...
**Last Updated:** `2026-09-25 17:48:26 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 27.09°C | 88.38% | `0.86` |
| **Panama City** | Panama | Dengue | 27.0°C | 88.43% | `0.86` |
| **Ho Chi Minh City** | Vietnam | Dengue | 26.93°C | 87.48% | `0.86` |
| **Bangkok** | Thailand | Dengue | 27.0°C | 87.05% | `0.86` |
| **Lagos** | Nigeria | Malaria | 26.17°C | 86.29% | `0.84` |
| **Singapore** | Singapore | Dengue | 27.15°C | 85.0% | `0.84` |
| **Colombo** | Sri Lanka | Dengue | 26.97°C | 84.57% | `0.84` |
| **Kolkata** | India | Dengue/Malaria | 28.41°C | 83.76% | `0.83` |
| **Manila** | Philippines | Dengue | 27.59°C | 83.05% | `0.83` |
| **Veracruz** | Mexico | Dengue | 27.48°C | 82.86% | `0.83` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.11°C | 82.33% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.51°C | 82.24% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.34°C | 84.38% | `0.82` |
| **Lucknow** | India | Dengue/JE | 27.51°C | 82.0% | `0.82` |
| **Cartagena** | Colombia | Dengue | 28.61°C | 82.14% | `0.82` |
| **Patna** | India | Dengue/Kala-azar | 28.27°C | 81.76% | `0.82` |
| **Miami** | United States | Low Baseline | 26.96°C | 79.86% | `0.81` |
| **Dakar** | Senegal | Malaria | 28.11°C | 80.05% | `0.81` |
| **San Juan** | Puerto Rico | Dengue | 28.18°C | 79.67% | `0.81` |
| **Guayaquil** | Ecuador | Dengue | 27.23°C | 78.33% | `0.80` |
| **Pune** | India | Dengue/Zika | 24.88°C | 79.05% | `0.78` |
| **Tegucigalpa** | Honduras | Dengue | 22.79°C | 84.43% | `0.75` |
| **Dhaka** | Bangladesh | Dengue | 29.54°C | 76.29% | `0.75` |
| **Tokyo** | Japan | Low Baseline | 22.08°C | 86.52% | `0.73` |
| **Rio de Janeiro** | Brazil | Dengue | 22.1°C | 85.9% | `0.73` |
| **Chennai** | India | Dengue/Chikungunya | 29.72°C | 73.52% | `0.72` |
| **Ahmedabad** | India | Dengue/Malaria | 29.01°C | 71.38% | `0.71` |
| **Bengaluru** | India | Dengue | 24.2°C | 73.19% | `0.70` |
| **New Delhi** | India | Dengue/Chikungunya | 28.89°C | 68.81% | `0.68` |
| **Hyderabad** | India | Dengue/Malaria | 27.37°C | 67.43% | `0.68` |
