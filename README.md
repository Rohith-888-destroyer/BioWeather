...
**Last Updated:** `2026-09-23 22:02:52 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 27.1°C | 88.24% | `0.86` |
| **Panama City** | Panama | Dengue | 26.98°C | 88.14% | `0.86` |
| **Ho Chi Minh City** | Vietnam | Dengue | 26.78°C | 88.1% | `0.86` |
| **Bhubaneswar** | India | Malaria/Dengue | 27.72°C | 87.33% | `0.86` |
| **Bangkok** | Thailand | Dengue | 27.08°C | 86.62% | `0.85` |
| **Lagos** | Nigeria | Malaria | 26.16°C | 86.52% | `0.85` |
| **Singapore** | Singapore | Dengue | 27.22°C | 84.76% | `0.84` |
| **Manila** | Philippines | Dengue | 27.21°C | 84.9% | `0.84` |
| **Kolkata** | India | Dengue/Malaria | 28.35°C | 84.38% | `0.84` |
| **Colombo** | Sri Lanka | Dengue | 27.01°C | 84.24% | `0.84` |
| **Santo Domingo** | Dominican Republic | Dengue | 26.95°C | 83.71% | `0.83` |
| **Lucknow** | India | Dengue/JE | 27.7°C | 83.29% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.35°C | 84.43% | `0.83` |
| **Patna** | India | Dengue/Kala-azar | 28.58°C | 82.0% | `0.82` |
| **Mumbai** | India | Dengue/Malaria | 27.53°C | 80.95% | `0.82` |
| **Cartagena** | Colombia | Dengue | 28.65°C | 81.71% | `0.82` |
| **Havana** | Cuba | Dengue | 27.42°C | 79.9% | `0.81` |
| **San Juan** | Puerto Rico | Dengue | 28.11°C | 80.14% | `0.81` |
| **Dakar** | Senegal | Malaria | 28.11°C | 80.14% | `0.81` |
| **Guayaquil** | Ecuador | Dengue | 27.2°C | 78.24% | `0.80` |
| **Pune** | India | Dengue/Zika | 24.98°C | 78.05% | `0.77` |
| **Dhaka** | Bangladesh | Dengue | 29.48°C | 77.57% | `0.77` |
| **Dar es Salaam** | Tanzania | Malaria | 25.48°C | 75.95% | `0.76` |
| **Tegucigalpa** | Honduras | Dengue | 23.07°C | 82.14% | `0.75` |
| **Tokyo** | Japan | Low Baseline | 22.09°C | 85.76% | `0.72` |
| **Ahmedabad** | India | Dengue/Malaria | 28.98°C | 72.1% | `0.72` |
| **Chennai** | India | Dengue/Chikungunya | 29.83°C | 73.29% | `0.71` |
| **Rio de Janeiro** | Brazil | Dengue | 21.85°C | 86.1% | `0.71` |
| **New Delhi** | India | Dengue/Chikungunya | 28.8°C | 71.19% | `0.71` |
| **Kampala** | Uganda | Malaria | 22.27°C | 81.62% | `0.69` |
| **Hyderabad** | India | Dengue/Malaria | 27.35°C | 67.86% | `0.69` |
| **Bengaluru** | India | Dengue | 24.63°C | 70.05% | `0.68` |
