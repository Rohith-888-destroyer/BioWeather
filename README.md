...
**Last Updated:** `2026-08-10 00:12:33 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 26.35°C | 91.76% | `0.88` |
| **Guwahati** | India | Malaria/JE | 28.12°C | 88.43% | `0.86` |
| **Kolkata** | India | Dengue/Malaria | 28.16°C | 87.52% | `0.86` |
| **Dhaka** | Bangladesh | Dengue | 28.3°C | 86.0% | `0.85` |
| **New Delhi** | India | Dengue/Chikungunya | 28.87°C | 85.38% | `0.84` |
| **Panama City** | Panama | Dengue | 27.57°C | 84.57% | `0.84` |
| **Manila** | Philippines | Dengue | 27.17°C | 84.62% | `0.84` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.62°C | 83.9% | `0.84` |
| **Lucknow** | India | Dengue/JE | 29.11°C | 84.9% | `0.84` |
| **Lagos** | Nigeria | Malaria | 25.51°C | 85.52% | `0.83` |
| **Jaipur** | India | Dengue/Malaria | 27.89°C | 83.24% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.45°C | 82.62% | `0.83` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.13°C | 81.1% | `0.82` |
| **Patna** | India | Dengue/Kala-azar | 29.47°C | 82.81% | `0.82` |
| **Veracruz** | Mexico | Dengue | 27.93°C | 80.57% | `0.81` |
| **Pune** | India | Dengue/Zika | 24.22°C | 85.38% | `0.81` |
| **Colombo** | Sri Lanka | Dengue | 27.47°C | 79.95% | `0.81` |
| **Accra** | Ghana | Malaria | 24.99°C | 82.24% | `0.81` |
| **Tokyo** | Japan | Low Baseline | 26.01°C | 80.1% | `0.81` |
| **Ahmedabad** | India | Dengue/Malaria | 28.52°C | 79.05% | `0.80` |
| **Singapore** | Singapore | Dengue | 28.13°C | 77.71% | `0.79` |
| **Dakar** | Senegal | Malaria | 28.23°C | 77.48% | `0.79` |
| **Hyderabad** | India | Dengue/Malaria | 25.84°C | 77.81% | `0.78` |
| **San Juan** | Puerto Rico | Dengue | 28.46°C | 77.29% | `0.78` |
| **Cartagena** | Colombia | Dengue | 29.44°C | 75.95% | `0.75` |
| **Bengaluru** | India | Dengue | 23.42°C | 78.62% | `0.73` |
| **Tegucigalpa** | Honduras | Dengue | 23.45°C | 76.86% | `0.71` |
| **Guayaquil** | Ecuador | Dengue | 27.78°C | 67.76% | `0.68` |
