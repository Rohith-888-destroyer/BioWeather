...
**Last Updated:** `2026-09-19 10:09:39 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Bhubaneswar** | India | Malaria/Dengue | 27.66°C | 87.76% | `0.86` |
| **Panama City** | Panama | Dengue | 27.03°C | 88.05% | `0.86` |
| **Ho Chi Minh City** | Vietnam | Dengue | 26.97°C | 87.1% | `0.86` |
| **Manila** | Philippines | Dengue | 26.83°C | 86.76% | `0.85` |
| **Guwahati** | India | Malaria/JE | 28.13°C | 86.29% | `0.85` |
| **Kolkata** | India | Dengue/Malaria | 28.24°C | 85.67% | `0.85` |
| **Bangkok** | Thailand | Dengue | 27.51°C | 84.9% | `0.84` |
| **Santo Domingo** | Dominican Republic | Dengue | 26.77°C | 85.14% | `0.84` |
| **Mumbai** | India | Dengue/Malaria | 27.19°C | 83.9% | `0.84` |
| **Colombo** | Sri Lanka | Dengue | 27.27°C | 82.52% | `0.83` |
| **Singapore** | Singapore | Dengue | 27.51°C | 82.52% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.34°C | 84.0% | `0.82` |
| **Veracruz** | Mexico | Dengue | 27.63°C | 81.48% | `0.82` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 27.27°C | 81.43% | `0.82` |
| **Accra** | Ghana | Malaria | 26.02°C | 81.81% | `0.82` |
| **San Juan** | Puerto Rico | Dengue | 27.97°C | 81.0% | `0.82` |
| **Havana** | Cuba | Dengue | 27.38°C | 80.71% | `0.82` |
| **Cartagena** | Colombia | Dengue | 28.97°C | 81.0% | `0.81` |
| **Dhaka** | Bangladesh | Dengue | 29.11°C | 80.9% | `0.81` |
| **Miami** | United States | Low Baseline | 27.62°C | 79.19% | `0.80` |
| **Dakar** | Senegal | Malaria | 28.6°C | 78.19% | `0.79` |
| **Pune** | India | Dengue/Zika | 24.7°C | 80.24% | `0.79` |
| **Guayaquil** | Ecuador | Dengue | 27.34°C | 76.33% | `0.78` |
| **Chennai** | India | Dengue/Chikungunya | 29.34°C | 77.57% | `0.77` |
| **Tokyo** | Japan | Low Baseline | 22.5°C | 87.33% | `0.76` |
| **Dar es Salaam** | Tanzania | Malaria | 25.45°C | 74.57% | `0.75` |
| **Ahmedabad** | India | Dengue/Malaria | 28.9°C | 74.19% | `0.74` |
| **Hyderabad** | India | Dengue/Malaria | 27.01°C | 71.48% | `0.73` |
| **New Delhi** | India | Dengue/Chikungunya | 29.07°C | 72.24% | `0.72` |
| **Kampala** | Uganda | Malaria | 22.41°C | 79.86% | `0.68` |
| **Jaipur** | India | Dengue/Malaria | 28.23°C | 68.19% | `0.68` |
| **Bengaluru** | India | Dengue | 24.83°C | 69.57% | `0.68` |
| **Jakarta** | Indonesia | Dengue | 28.88°C | 67.81% | `0.67` |
