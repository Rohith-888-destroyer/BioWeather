...
**Last Updated:** `2026-09-04 19:13:50 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Bhubaneswar** | India | Malaria/Dengue | 28.06°C | 86.95% | `0.85` |
| **Kolkata** | India | Dengue/Malaria | 28.58°C | 87.38% | `0.85` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 26.48°C | 85.29% | `0.84` |
| **Dhaka** | Bangladesh | Dengue | 28.64°C | 84.48% | `0.84` |
| **Tokyo** | Japan | Low Baseline | 25.04°C | 84.81% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.27°C | 84.95% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.18°C | 82.29% | `0.82` |
| **Manila** | Philippines | Dengue | 27.47°C | 81.9% | `0.82` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.8°C | 81.81% | `0.82` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.41°C | 81.86% | `0.82` |
| **Accra** | Ghana | Malaria | 25.96°C | 82.43% | `0.82` |
| **Bangkok** | Thailand | Dengue | 28.0°C | 80.95% | `0.82` |
...
| **Miami** | United States | Low Baseline | 28.55°C | 78.57% | `0.79` |
| **New Delhi** | India | Dengue/Chikungunya | 29.01°C | 79.0% | `0.79` |
| **Dakar** | Senegal | Malaria | 28.82°C | 78.38% | `0.79` |
| **Pune** | India | Dengue/Zika | 24.5°C | 80.71% | `0.79` |
| **Singapore** | Singapore | Dengue | 28.17°C | 76.0% | `0.77` |
| **Havana** | Cuba | Dengue | 28.59°C | 76.14% | `0.77` |
| **Dar es Salaam** | Tanzania | Malaria | 25.09°C | 76.0% | `0.76` |
| **Tegucigalpa** | Honduras | Dengue | 24.0°C | 76.19% | `0.73` |
| **Jaipur** | India | Dengue/Malaria | 28.39°C | 71.81% | `0.72` |
| **Hyderabad** | India | Dengue/Malaria | 26.7°C | 69.33% | `0.70` |
| **Bengaluru** | India | Dengue | 24.0°C | 74.0% | `0.70` |
| **Rio de Janeiro** | Brazil | Dengue | 21.59°C | 84.81% | `0.67` |
| **Chennai** | India | Dengue/Chikungunya | 30.32°C | 69.43% | `0.65` |
