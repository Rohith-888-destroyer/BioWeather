...
**Last Updated:** `2026-09-11 23:51:50 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 26.65°C | 90.24% | `0.87` |
| **Panama City** | Panama | Dengue | 26.92°C | 88.81% | `0.86` |
| **Kolkata** | India | Dengue/Malaria | 28.24°C | 87.19% | `0.85` |
| **Lucknow** | India | Dengue/JE | 27.92°C | 86.81% | `0.85` |
| **Bhubaneswar** | India | Malaria/Dengue | 27.9°C | 86.29% | `0.85` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.29°C | 85.05% | `0.84` |
| **Dhaka** | Bangladesh | Dengue | 28.37°C | 85.05% | `0.84` |
| **Lagos** | Nigeria | Malaria | 26.39°C | 85.76% | `0.84` |
| **Manila** | Philippines | Dengue | 26.91°C | 84.62% | `0.84` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.15°C | 83.19% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.01°C | 83.43% | `0.83` |
| **Bangkok** | Thailand | Dengue | 27.8°C | 82.62% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.46°C | 84.24% | `0.83` |
| **Cartagena** | Colombia | Dengue | 29.02°C | 82.24% | `0.82` |
| **Accra** | Ghana | Malaria | 26.18°C | 81.38% | `0.82` |
| **Miami** | United States | Low Baseline | 28.0°C | 80.43% | `0.81` |
| **Veracruz** | Mexico | Dengue | 28.19°C | 80.52% | `0.81` |
| **Colombo** | Sri Lanka | Dengue | 27.61°C | 80.33% | `0.81` |
| **Tokyo** | Japan | Low Baseline | 23.35°C | 86.86% | `0.80` |
| **Havana** | Cuba | Dengue | 28.13°C | 78.48% | `0.80` |
| **Singapore** | Singapore | Dengue | 27.85°C | 78.1% | `0.79` |
| **New Delhi** | India | Dengue/Chikungunya | 28.59°C | 78.62% | `0.79` |
| **Pune** | India | Dengue/Zika | 24.51°C | 79.76% | `0.78` |
| **Dakar** | Senegal | Malaria | 29.04°C | 76.67% | `0.77` |
| **Jaipur** | India | Dengue/Malaria | 27.77°C | 74.0% | `0.75` |
| **Dar es Salaam** | Tanzania | Malaria | 25.14°C | 75.24% | `0.75` |
| **Tegucigalpa** | Honduras | Dengue | 24.04°C | 75.48% | `0.72` |
| **Chennai** | India | Dengue/Chikungunya | 29.84°C | 73.67% | `0.72` |
| **Rio de Janeiro** | Brazil | Dengue | 21.74°C | 87.24% | `0.71` |
| **Hyderabad** | India | Dengue/Malaria | 27.16°C | 67.81% | `0.69` |
| **Bengaluru** | India | Dengue | 24.79°C | 69.62% | `0.68` |
| **Ahmedabad** | India | Dengue/Malaria | 29.48°C | 67.76% | `0.65` |
