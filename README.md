...
**Last Updated:** `2026-09-08 17:05:34 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 26.36°C | 91.29% | `0.87` |
| **Panama City** | Panama | Dengue | 27.02°C | 88.67% | `0.86` |
| **Lucknow** | India | Dengue/JE | 27.87°C | 88.38% | `0.86` |
| **Guwahati** | India | Malaria/JE | 27.99°C | 87.52% | `0.86` |
| **Kolkata** | India | Dengue/Malaria | 28.48°C | 86.76% | `0.85` |
| **Patna** | India | Dengue/Kala-azar | 28.67°C | 86.19% | `0.85` |
| **Lagos** | Nigeria | Malaria | 26.37°C | 85.76% | `0.84` |
| **Manila** | Philippines | Dengue | 27.05°C | 84.29% | `0.84` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.48°C | 83.52% | `0.84` |
| **Dhaka** | Bangladesh | Dengue | 28.61°C | 84.0% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.04°C | 83.05% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.31°C | 84.9% | `0.83` |
| **Tokyo** | Japan | Low Baseline | 24.2°C | 85.95% | `0.82` |
| **Accra** | Ghana | Malaria | 26.23°C | 80.76% | `0.81` |
| **San Juan** | Puerto Rico | Dengue | 28.18°C | 80.29% | `0.81` |
| **Colombo** | Sri Lanka | Dengue | 27.64°C | 79.86% | `0.81` |
| **Miami** | United States | Low Baseline | 28.14°C | 79.86% | `0.81` |
| **Cartagena** | Colombia | Dengue | 29.11°C | 80.95% | `0.81` |
| **Veracruz** | Mexico | Dengue | 28.54°C | 78.86% | `0.80` |
| **New Delhi** | India | Dengue/Chikungunya | 28.7°C | 79.0% | `0.79` |
| **Singapore** | Singapore | Dengue | 27.89°C | 77.81% | `0.79` |
| **Pune** | India | Dengue/Zika | 24.5°C | 79.95% | `0.78` |
| **Dakar** | Senegal | Malaria | 29.02°C | 76.14% | `0.76` |
| **Jaipur** | India | Dengue/Malaria | 27.89°C | 74.1% | `0.75` |
| **Guayaquil** | Ecuador | Dengue | 27.37°C | 72.38% | `0.74` |
| **Tegucigalpa** | Honduras | Dengue | 24.29°C | 74.71% | `0.72` |
| **Rio de Janeiro** | Brazil | Dengue | 22.09°C | 85.71% | `0.72` |
| **Hyderabad** | India | Dengue/Malaria | 26.99°C | 68.71% | `0.70` |
| **Chennai** | India | Dengue/Chikungunya | 30.2°C | 71.43% | `0.68` |
| **Bengaluru** | India | Dengue | 24.72°C | 68.71% | `0.66` |
| **Kinshasa** | DR Congo | Malaria | 26.15°C | 66.33% | `0.66` |
