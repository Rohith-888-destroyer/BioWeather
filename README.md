...
**Last Updated:** `2026-08-30 00:12:32 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Panama City** | Panama | Dengue | 26.91°C | 89.57% | `0.87` |
| **Bhubaneswar** | India | Malaria/Dengue | 27.96°C | 87.29% | `0.86` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 26.16°C | 86.81% | `0.85` |
| **Kolkata** | India | Dengue/Malaria | 28.71°C | 86.24% | `0.85` |
| **Manila** | Philippines | Dengue | 27.43°C | 82.48% | `0.83` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.62°C | 82.43% | `0.83` |
| **Dhaka** | Bangladesh | Dengue | 28.82°C | 83.1% | `0.83` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.34°C | 84.52% | `0.83` |
| **Tokyo** | Japan | Low Baseline | 25.85°C | 82.81% | `0.82` |
| **Mumbai** | India | Dengue/Malaria | 27.36°C | 81.62% | `0.82` |
| **Veracruz** | Mexico | Dengue | 27.86°C | 81.38% | `0.82` |
| **Santo Domingo** | Dominican Republic | Dengue | 27.37°C | 81.1% | `0.82` |
| **Bangkok** | Thailand | Dengue | 27.9°C | 81.0% | `0.82` |
| **Accra** | Ghana | Malaria | 25.96°C | 81.62% | `0.81` |
| **Colombo** | Sri Lanka | Dengue | 27.45°C | 80.62% | `0.81` |
| **Cartagena** | Colombia | Dengue | 28.97°C | 80.24% | `0.80` |
| **Singapore** | Singapore | Dengue | 27.85°C | 78.67% | `0.80` |
| **Pune** | India | Dengue/Zika | 24.3°C | 82.43% | `0.79` |
| **New Delhi** | India | Dengue/Chikungunya | 29.3°C | 79.57% | `0.79` |
| **Dakar** | Senegal | Malaria | 28.84°C | 77.95% | `0.78` |
| **Miami** | United States | Low Baseline | 28.99°C | 76.57% | `0.77` |
| **Havana** | Cuba | Dengue | 28.43°C | 75.81% | `0.77` |
| **Dar es Salaam** | Tanzania | Malaria | 24.94°C | 76.38% | `0.76` |
| **Jaipur** | India | Dengue/Malaria | 28.35°C | 72.95% | `0.74` |
| **Tegucigalpa** | Honduras | Dengue | 23.83°C | 77.33% | `0.73` |
| **Hyderabad** | India | Dengue/Malaria | 26.3°C | 71.52% | `0.73` |
| **Bengaluru** | India | Dengue | 23.66°C | 75.95% | `0.71` |
| **Ahmedabad** | India | Dengue/Malaria | 29.44°C | 68.62% | `0.67` |
