...
**Last Updated:** `2026-08-26 16:45:04 UTC`  
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| **Yangon** | Myanmar | Malaria/Dengue | 26.21°C | 92.0% | `0.88` |
| **Panama City** | Panama | Dengue | 27.1°C | 89.05% | `0.86` |
| **Bhubaneswar** | India | Malaria/Dengue | 27.81°C | 88.62% | `0.86` |
| **Lucknow** | India | Dengue/JE | 28.51°C | 88.62% | `0.86` |
| **Thiruvananthapuram** | India | Dengue/Chikungunya | 26.02°C | 87.33% | `0.85` |
| **Kolkata** | India | Dengue/Malaria | 28.57°C | 86.62% | `0.85` |
| **Tokyo** | Japan | Low Baseline | 25.78°C | 84.62% | `0.84` |
| **Manila** | Philippines | Dengue | 27.39°C | 83.24% | `0.83` |
| **Dhaka** | Bangladesh | Dengue | 28.91°C | 83.43% | `0.83` |
| **Veracruz** | Mexico | Dengue | 27.57°C | 82.19% | `0.83` |
| **Mumbai** | India | Dengue/Malaria | 27.31°C | 82.19% | `0.82` |
| **Abidjan** | Cote d'Ivoire | Malaria | 25.22°C | 84.43% | `0.82` |
| **Accra** | Ghana | Malaria | 25.7°C | 82.43% | `0.82` |
| **Colombo** | Sri Lanka | Dengue | 27.33°C | 81.05% | `0.82` |
| **Ho Chi Minh City** | Vietnam | Dengue | 27.91°C | 80.62% | `0.81` |
| **Bangkok** | Thailand | Dengue | 28.06°C | 79.76% | `0.81` |
| **Pune** | India | Dengue/Zika | 24.28°C | 83.14% | `0.80` |
| **San Juan** | Puerto Rico | Dengue | 28.52°C | 78.1% | `0.79` |
| **New Delhi** | India | Dengue/Chikungunya | 29.58°C | 79.86% | `0.79` |
| **Cartagena** | Colombia | Dengue | 29.2°C | 78.52% | `0.78` |
| **Singapore** | Singapore | Dengue | 28.24°C | 76.9% | `0.78` |
| **Dakar** | Senegal | Malaria | 28.76°C | 77.52% | `0.78` |
| **Miami** | United States | Low Baseline | 29.15°C | 76.67% | `0.77` |
| **Havana** | Cuba | Dengue | 28.6°C | 75.0% | `0.76` |
| **Dar es Salaam** | Tanzania | Malaria | 24.85°C | 76.38% | `0.76` |
| **Jaipur** | India | Dengue/Malaria | 28.59°C | 72.71% | `0.73` |
| **Hyderabad** | India | Dengue/Malaria | 26.38°C | 71.67% | `0.73` |
| **Ahmedabad** | India | Dengue/Malaria | 29.01°C | 72.38% | `0.72` |
| **Tegucigalpa** | Honduras | Dengue | 23.83°C | 76.24% | `0.72` |
| **Bengaluru** | India | Dengue | 23.5°C | 76.71% | `0.71` |
| **Guayaquil** | Ecuador | Dengue | 27.47°C | 69.71% | `0.71` |
| **Rio de Janeiro** | Brazil | Dengue | 22.5°C | 81.14% | `0.70` |
